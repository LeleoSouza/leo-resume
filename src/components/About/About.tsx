          ...
          <Grid>
            ...
            <FadeContent blur={true} duration={1500} easing='ease-out' initialOpacity={0}>
              <Typography color='white'>
                I’ve always been drawn to how technology can solve real problems and make people’s lives easier. Over
                the past few years, I’ve honed my skills as a frontend engineer by working on everything from government
                tools to internal platforms that teams rely on daily. I enjoy digging into the details—whether that’s
